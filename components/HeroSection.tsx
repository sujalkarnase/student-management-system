        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              ...
              <Link href="#features" className="bg-white text-foreground border border-border px-8 py-4 rounded-xl text-lg font-bold flex items-center gap-2 hover:bg-muted/50 transition-all">
