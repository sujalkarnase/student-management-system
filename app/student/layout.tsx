                        ...
                        <div className="flex items-center gap-3 pl-6 border-l border-slate-200">
                            <div className="text-right hidden sm:block">
                                {status === "loading" ? (
                                    ...
                                    <>
                                        <p className="text-sm font-bold text-[#0F172A]">{session?.user?.name || "Student"}</p>
                                        <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Enrolled Student</p>
                                    </>
                                )}
                            </div>
