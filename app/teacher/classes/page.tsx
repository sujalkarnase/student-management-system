            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {classes.map((assignment, idx) => {
                        // Dynamic styling based on Subject
                        const getSubjectColors = (subjectName: string) => {
                            ...
                            return { bg: 'bg-slate-800', shadow: 'shadow-slate-500/30', lightTheme: 'bg-slate-100', hover: 'group-hover:bg-slate-200', text: 'text-slate-800' }; // Default
                        };
